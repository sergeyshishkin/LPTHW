...
#     user_choice = input("> ")
#
#     if user_choice in weather_options:
#         weather_conditions = weather_options[user_choice]
...
#         print("Damage is just",damage,"Shaking hands, huh?")
...
heat = """Here is a base. Guard stands at the door. It's too hot. You understand that you can trick guard, to slip to the base.
As remember, you have 'items'. What you can offer, to distract his attention?"""


#if the weather is stormy
storm = """Here is a base. Guard stands at the door. It's very windy, almost stormy. You understand that you can trick guard, to slip to the base.
As remember, you have 'items'. What you can offer, to distract his attention?"""


# if te weather is Cloudy
cloudy = """Here is a base. Guard stands at the door. It's cloudy, and melancholic weather. You understand that you can trick guard, to slip to the base.
As remember, you have 'items'. What you can offer, to distract his attention?"""
